public class IfElse {
    ...
    public static void main(String[] args) {
        ...
        if (age >= retirementAge) {
            ...
            System.err.println("You still have to work for " + (retirementAge - age) + " years");
        }
        ...
        if (myGrade == bestGrade) {
            System.err.println("Congrats, you got the highest score!");
        } else {
            System.err.println("No, but you will next time!");
        }
        ...
        if (word.equals(secondWord)) {
            ...
            System.err.println("Ther are not");
        }
        ...
        if (!thirdWord.equals(fourthWord)) {
            System.err.println("They are indeed different");
        } else {
            System.err.println("No, they are not");
        }
    }
}
